...
if __name__ == "__main__":
    ...
    test_files_directory = "../../data set/training/"
    ...
    extracted_data_df = pd.read_excel("extracted_data_training.xlsx")

    modified_excel_file_path = "modified_data_training.xlsx"
    ...
    sequence_run_df.to_excel("sequence_runs_training.xlsx", index=False)
    ...
    # Read the Excel file into a DataFrame
    filtered_df_with_mock_up_time = pd.read_excel("modified_data_training.xlsx")
    ...
    df_without_stop_words.to_excel("preprocess_stopwords_training.xlsx", index=False)

    print(
        "\nFiltered stop words data stored in preprocess_stopwords_training.xlsx successfully."
    )
    ...
    # Read the Excel file into a DataFrame
    modified_data_df = pd.read_excel("preprocess_stopwords_training.xlsx")
    ...
    # Save the updated DataFrame to a new Excel file
    lemmatized_df.to_excel("preprocess_stemming_lemmatizing_training.xlsx", index=False)
    print(
        "\nLemmatized/stemmed data stored in preprocess_stemming_lemmatizing_training.xlsx successfully."
    )
