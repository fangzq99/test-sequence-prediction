...
if __name__ == "__main__":
    ...
    bow_df = pd.read_excel("../../manual labelling/full/manual_labelled.xlsx")
    ...
    bow_df.to_excel("BoW_vectorize.xlsx", index=False)
    print("\nData feature extracted and stored in BoW_vectorize.xlsx successfully.")
