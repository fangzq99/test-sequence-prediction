...
if __name__ == "__main__":
    ...
    tfidf_vectorizer_df = pd.read_excel(
        "../../manual labelling/training/manual_labelled_trainingset.xlsx"
    )
    ...
    tfidf_df.to_excel("tfidf_vectorize_training.xlsx", index=False)
    print(
        "\nData feature extracted and stored in tfidf_vectorize_training.xlsx successfully."
    )
