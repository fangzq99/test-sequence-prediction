...
import { assignUsersOperatorFirstName, baseURL, companyUserCo, LBSuperAdmin, LBSuperAdminPassword } from '../../../../../support/Region Constants/constants.js'
...
context("Search tests (Users)", () => {
    context('LB Super Admin', () => {
        ...
        it('Search for username: ' + userNameSubstrings + ' and its substrings', () => {
            userSearchTerms(userNameSubstrings, 100)
        })
        // it('certificate test', () => {
