...
context("Search tests (Robots)", () => {
    context('LB Super Admin', () => {
        ...
        it('Search for comapany and its distrbutors: ' + companyAndDistributorSearchSubstrings + ' and its substrings', () => {
            robotSearchTerms(companyAndDistributorSearchSubstrings, 100)
        })
        // it('deployed',()=>{        
