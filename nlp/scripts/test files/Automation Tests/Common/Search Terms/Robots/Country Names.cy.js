...
import { getDateSearchTerms, verifyAPI } from '../../../../../support/generalCommands.js'
import { baseURL, commonlyUsedRobots, companyUserCo, companyUserWork, companyValidationMD, intermediateTimeout, LBSuperAdmin, LBSuperAdminPassword, mediumTimeout } from '../../../../../support/Region Constants/constants.js'
...
context("Search tests (Robots)", () => {
    context('LB Super Admin', () => {
        ...
        it('Search for country: ' + countryString + ' and its substrings', () => {
            robotSearchTerms(countrySearchSubstrings, 100)
        })
        // it('deployed',()=>{        
